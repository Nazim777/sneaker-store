...
export default function CartItem({ state }: { state: CartState }) {
              ...
              <div className="flex flex-1 flex-col justify-between">
                <div className="flex flex-col sm:flex-row justify-between items-start gap-1">
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-sm md:text-lg leading-tight uppercase tracking-tight  sm:whitespace-normal">
                      {item.product.title}
                    </h3>
